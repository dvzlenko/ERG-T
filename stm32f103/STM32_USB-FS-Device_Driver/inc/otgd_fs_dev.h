...
#define EP0_IN                     0x80  
#define EP1_OUT                    0x01  
#define EP1_IN                     0x81		// in ANDROID: IF = device.getInterface(1); --> EP = IF.getEndpoint(1); 
#define EP2_OUT                    0x02  
#define EP2_IN                     0x82		// in ANDROID: IF = device.getInterface(0); --> EP = IF.getEndpoint(0);
#define EP3_OUT                    0x03		// in ANDROID: IF = device.getInterface(1); --> EP = IF.getEndpoint(0); 
#define EP3_IN                     0x83  
